...
const ChatDocumentTypeList = () => {
  const { practiceAreaId,documentTypeId } = useParams();
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      try {
        const response = await axios.get(`https://dev.ciceroai.net/api/documents/${documentTypeId}/area/${practiceAreaId}`); // Adjust your endpoint as necessary
              ...
              <tr key={index}>
                  ...
                  <div className="d-flex justify-content-between fw-semibold">
                    <div className="d-flex align-items-center poppins fs15 gap-2">
                      ...
                      <svg width="20" height="20" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M10.1908 18.9167V20C10.1908 21.7949 11.6459 23.25 13.4408 23.25C15.2357 23.25 16.6908 21.7949 16.6908 20V18.9167" stroke="#4B465C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M10.1908 18.9167V20C10.1908 21.7949 11.6459 23.25 13.4408 23.25C15.2357 23.25 16.6908 21.7949 16.6908 20V18.9167" stroke="white" stroke-opacity="0.2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                    </span>
                    
                  </div>
                </td>
                <td className='fs15 public-sans'>{doc.filepath}</td>
                <td>
                  <div className="d-flex gap-2 uploaded-file-icon">
                   
                      <span key={index} className="file-icon">
                        <Button className="light-cyan-bg text-white d-flex align-items-center gap-2 position-relative">
                          ...
                          <span className="midnight-blue fs14">{doc.filepath}</span>
                        </Button>
                      </span>
                ...
                <td>
                  ...
                  <svg width="20" height="20" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 7.5H6C4.89543 7.5 4 8.39543 4 9.5V18.5C4 19.6046 4.89543 20.5 6 20.5H15C16.1046 20.5 17 19.6046 17 18.5V15.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M9 15.5H12L20.5 6.99998C21.3284 6.17156 21.3284 4.82841 20.5 3.99998C19.6716 3.17156 18.3284 3.17156 17.5 3.99998L9 12.5V15.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M16 5.5L19 8.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  </Link>

                  <svg width="20" height="20" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 7.5H20" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M10 11.5V17.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M14 11.5V17.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M5 7.5L6 19.5C6 20.6046 6.89543 21.5 8 21.5H16C17.1046 21.5 18 20.6046 18 19.5L19 7.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M9 7.5V4.5C9 3.94772 9.44772 3.5 10 3.5H14C14.5523 3.5 15 3.94772 15 4.5V7.5" stroke="#8B909A" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  </div>
                </td>
              </tr>
...
export default ChatDocumentTypeList;