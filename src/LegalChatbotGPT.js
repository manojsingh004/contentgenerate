...
const LegalChatbotGPT = () => {
    ...
    const handlePrintComplete = useReactToPrint({
        ...
        onBeforeGetContent: ()=>{
            console.log();
            // setActivePrint(current=>true);
        },
        onAfterPrint: () =>{
            setActivePrint(current=>false);
            //  alert("Print success!")
            },
    ...
    const downloadExcel = () => {
        const questionsData = responseQuestion.questions[activeFileName] || [];
        const answers = responseQuestion.answers[activeFileName] || [];
        console.log(questionsData,'test50')
        const newData = questionsData.map((item,key)=>{
            console.log(item)
            return {
                        ...
                        <Row className="RightPanelSide bg-white mx-2 rounded-25 shadow-sm">
                            ...
                            <div className="d-flex align-items-center justify-content-between gap-2">
                                ...
                                <div className="d-flex align-items-center justify-content-end case-download-options">
                                    <button
                                    onMouseEnter={()=>setActivePrint(true)}
                                    onMouseLeave={()=>setActivePrint(false)}
                                    onClick={()=>{
                                        setActivePrint(true);
                                        handlePrintComplete();
                                    ...
                                    <button className="bg-transparent border-0" onClick={downloadExcel} >
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td className="p-2 text-center">
                                                                ...
                                                                <Form.Control
                                                                    ...
                                                                    className={`${((comments?.[activeFileName]?.[key] || '') ==''&& activePrint)?'d-none':''}`}
                                                                    style={{ height: '100px' }}
                                                                />
                                                                {/* <button
