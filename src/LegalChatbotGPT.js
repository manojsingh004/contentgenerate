...
const generateDocx = async () => {
    ...
    const doc = new Document({
        sections: [{
            ...
            children: [
                new Paragraph({
                    children: [
                        new TextRun("Here are your dynamic references:"),
    ...
    try {
        ...
        link.download = "References.docx"; // This hint can still help in some cases
                        ...
                        <Row className="RightPanelSide bg-white mx-2 rounded-25 shadow-sm">
                            ...
                            <div className="d-flex align-items-center justify-content-between gap-2">
                                ...
                                <div className="d-flex align-items-center justify-content-end case-download-options">
                                    ...
                                    <button className="bg-transparent border-0" onClick={handlePrintComplete} >
                            ...
                            <div className="d-flex">
                                <span className="fs18 position-relative pe-2">{fileName}
